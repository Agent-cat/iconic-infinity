      ...
      <section className="py-32 px-4 bg-gradient-to-b from-black to-blue-950">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              {
                title: "Our Vision",
                description: "To be the global leader in innovative solutions, setting new standards in customer experience and technological advancement.",
                color: "from-blue-500 to-blue-700"
              },
              {
                title: "Our Mission",
                description: "To deliver exceptional value through customer-centric innovation, sustainable practices, and unwavering quality standards.",
                color: "from-blue-600 to-blue-800"
              },
              {
                title: "Our Promise",
                description: "To exceed expectations through continuous innovation, ethical practices, and a commitment to excellence in everything we do.",
              ...
              >
                ...
                <h2 className="text-3xl font-bold mb-6 text-blue-400">{item.title}</h2>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <motion.div
                ...
                <h3 className="text-2xl font-bold mt-8 mb-4 text-blue-400">{value.title}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <motion.div
                ...
                >
                  ...
                  <div className="p-6">
                  <h3 className="text-2xl font-bold mb-2 text-blue-400">{leader.name}</h3>
